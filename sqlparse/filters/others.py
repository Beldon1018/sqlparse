...
class StripWhitespaceFilter:
    ...
    def _stripws_parenthesis(self, tlist):
        # handling of degenerate parenthesis groups, e.g. "( AS )",
        # where the parenthesis may contain a single grouped token
        while len(tlist.tokens) > 1 and tlist.tokens[1].is_whitespace:
            tlist.tokens.pop(1)
